<?php
	$openinviter_settings=array(
		"username"=>"sdhpola",
		"private_key"=>"29919608b0380b68366183ff35efc2b5",
		"cookie_path"=> dirname(__FILE__).'/tmp',
		"message_body"=>"You are invited to www.greenpeace.org", // www.greenpeace.org is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to www.greenpeace.org", // www.greenpeace.org is the website on your account. If wrong, please update your account at OpenInviter.com
