...
require_once CONSOLE_LIBS.'tasks'.DS.'project.php';
class DebuggableProjectTask extends ProjectTask {
/**
 * Override
 *
 * @access public
 ...
 */
	function execute($project = null) {
		...
		if (empty($this->params['skel'])) {
			$this->params['skel'] = '';
			if (is_dir(VENDORS.'shells'.DS.'templates'.DS.'skel') === true) {
				$this->params['skel'] = VENDORS.'shells'.DS.'templates'.DS.'skel';
			} else {
