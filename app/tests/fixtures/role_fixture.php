...
class RoleFixture extends CakeTestFixture {
	...
	var $records = array(
		array(
			...
			'name' => 'admin',
			'permissions' => '*:*, !Offices:admin_index, !Offices:admin_add, !Offices:admin_delete, !Users:admin_index, !Bugs:admin_index, !Offices:admin_index, !Roles:*, !Logs:*, !Appeals:publish',
			'office_id' => '',
