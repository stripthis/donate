...
<h2><?php  __('Post');?></h2>
  <div class="actions">
    ...
    <ul>
      ...
      <li><?php echo $html->link(__('Delete Post', true), array('action'=>'delete', $post['Post']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $post['Post']['id']),array('class'=>'delete')); ?> </li>
