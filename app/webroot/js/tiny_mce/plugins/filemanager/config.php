<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,refresh,zip,upload,edit,rename,cut,copy,paste,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
	...
	if (isset($_COOKIE['CakeCookie']['Auth']['name'])) {
		...
		$mcFileManagerConfig['filesystem.rootpath'] = 'files/' . $path . '/';
		@mkdir($mcFileManagerConfig['filesystem.rootpath'], 0775);
	}
	...
	$mcFileManagerConfig['authenticator.login_page'] = "/auth/login";
