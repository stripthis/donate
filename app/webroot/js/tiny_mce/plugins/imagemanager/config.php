<?php
	...
	$mcImageManagerConfig['general.tools'] = "createdir,upload,refresh,addfavorite,removefavorite,insert,edit,preview"; // "filemanager" button if you have "filemanager.urlprefix" configured.
	...
	if (isset($_COOKIE['CakeCookie']['Auth']['name'])) {
		$path = substr(sha1($_COOKIE['CakeCookie']['Auth']['name']), 0, 10);
		$mcImageManagerConfig['filesystem.rootpath'] = 'files/' . $path . '/';
		@mkdir($mcImageManagerConfig['filesystem.rootpath'], 0775);
	}
	...
	$mcImageManagerConfig['filesystem.clean_names'] = false;
	...
	$mcImageManagerConfig['upload.max_width'] = "500"; // Only if force_width_height is true
	...
	$mcImageManagerConfig['authenticator.login_page'] = "http://lookbooks.com/auth/login";
	...
	$mcImageManagerConfig['SessionAuthenticator.rootpath_key'] = "/www/myroot";
